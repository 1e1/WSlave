...
#define LCDPOSITION_TITLE           0, 0
#define LCDPOSITION_PAGE_OFFSET     1
#define LCDPOSITION_PAGE_LENGTH     2
// "X##/PP" = 1+ LCDPOSITION_PAGE_LENGTH +1+ LCDPOSITION_PAGE_LENGTH
#define LCDPOSITION_TITLE_LENGTH      - LCDPOSITION_PAGE_OFFSET - (2*LCDPOSITION_PAGE_LENGTH) -2

#define LCDPOSITION_DESCRIPTION     1, 0
// space between <ON> and <OFF>
#define LCDPOSITION_DIGITAL_INSET   2
// "<ON>  <OFF>" = 1+ STRLEN(ON) +1 +LCDPOSITION_DIGITAL_INSET+ 1+ STRLEN(OFF) +1
#define LCDPOSITION_DIGITAL         1, ((  LCD_WIDTH - (1+ strlen("ON") +1 +LCDPOSITION_DIGITAL_INSET+ 1+ strlen("OFF") +1)  )/2)
...
#define LCDPOSITION_ANALOG          1, ((  LCD_WIDTH - (1+LCDPOSITION_BAR_LENGTH+1 +LCDPOSITION_ANALOG_OFFSET+ LCDPOSITION_VALUE_LENGTH)  )/2)
